...
namespace project
{
    public partial class Bio : Form
    {
        ...
        public Bio()
        {
            ...
            graph.Chart = chart1;
            graph.FirstPrice = 803000;
            graph.ChangePrice = 15320;
            graph.GraphReset();
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            else if (graph.currentprice < graph.FirstPrice)
            {
        ...
        private void Bio_FormClosed(object sender, FormClosedEventArgs e)
        {
            graph.Stop();
        }

        private void Bio_FormClosing(object sender, FormClosingEventArgs e)
        {
            Hide();
            e.Cancel = true;
        }
