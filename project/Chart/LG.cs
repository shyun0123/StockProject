...
namespace project
{
    ...
    public partial class LG : Form
    {
        ...
        public LG()
        {
            ...
            graph.Chart = chart1;
            graph.FirstPrice = 560000;
            graph.ChangePrice = 11200;
            graph.GraphReset();
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            isVisible = !isVisible;
            //home.SetAll("LG에너지솔루션", graph.currentprice, (graph.currentprice - graph.FirstPrice), ((double)(graph.currentprice - graph.FirstPrice) / graph.FirstPrice));
        }
