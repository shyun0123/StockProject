...
namespace project
{
    public partial class POSCO : Form
    {
        ...
        public POSCO()
        {
            ...
            graph.Chart = chart1;
            graph.FirstPrice = 622000;
            graph.ChangePrice = 12840;
            graph.GraphReset();
        ...
        private void POSCO_FormClosed(object sender, FormClosedEventArgs e)
        {
            graph.Stop();
        }

        private void POSCO_FormClosing(object sender, FormClosingEventArgs e)
        {
            Hide();
            e.Cancel = true;
        }
